...
Here we show how to use the functions in the `dgp` package to implement the method proposed in Li et al. (2023). To implement STS [(Kovac, 2007)](http://cran.nexr.com/web/packages/ftnonpar/index.html), and NKS (Song et. al, 2006) method, one requires the `ftnonpar` and `KernSmooth` packages.
